...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="static/css/styles.css?v=1.7.5">
    <!-- 弹窗公告 -->
    <link rel="stylesheet" type="text/css" href="static/css/notification.css?v=1.7.5">
    <script type="text/javascript" src="static/js/notification.js?v=1.7.5" defer></script>
    <!-- 不需要的直接注释这两行 -->
</head>
<body>
    <header class="blur">
    ...
    <script type="text/javascript" src="static/js/script.js?v=1.7.5" defer></script>
    <!-- 引入鼠标指针跟随特效 -->
    <script type="text/javascript" src="static/js/cursor.js?v=1.7.5" defer></script>
</body>
</html>